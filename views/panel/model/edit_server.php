...
<div class="form-group">
   ...
   <!--<div class="form-group">
    ...
    <input type="text" class="form-control" id="SSLCertificateFile2" placeholder="/path/to/your_domain_name.crt" value="<?=$server[0]['SSLCertificateFile']?>">
  </div>
  <div class="form-group">
    <label for="SSLCertificateKeyFile">SSLCertificateKeyFile</label>
    <input type="text" class="form-control" id="SSLCertificateKeyFile2" placeholder="/path/to/your_private.key" value="<?=$server[0]['SSLCertificateKeyFile']?>">
  </div>
  
  <div class="form-group">
    <label for="SSLCertificateChainFile">SSLCertificateChainFile</label>
    <input type="text" class="form-control" id="SSLCertificateChainFile2" placeholder="/path/to/Digicertcx.crt" value="<?=$server[0]['SSLCertificateChainFile']?>">
  </div>
  <!--
