...
class Myrules extends CI_Controller {
	...
	function whitelist(){
		...
		$this->datasistem->write_whitelist($this->input->post('host'));
	...
	function disable_per_server(){
			...
			'host' => $this->input->post('host'),
                ...
                echo $this->datasistem->save($simpan,'tblid_added1');


                $this->datasistem->write_disablelist_per_server($this->input->post('host'));
	...
	function ownlist(){
		...
		$this->datasistem->write_ownlist($this->input->post('host'),$this->input->post('name'),$this->input->post('rules'));
